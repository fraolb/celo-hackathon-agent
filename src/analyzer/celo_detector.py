...
class CeloIntegrationDetector:
    ...
    def check_without_access(self, repo_owner: str, repo_name: str, repo_description: str) -> CeloIntegrationResult:
        """
        ...
        if self.llm is not None:
            try:
                return self.estimate_integration_with_ai(repo_owner, repo_name, repo_description)
    ...
    def estimate_integration_with_ai(self, repo_owner: str, repo_name: str, repo_description: str) -> CeloIntegrationResult:
        """
        ...
        try:
            ...
            raise AIAnalysisError(f"Error in AI estimation of Celo integration: {str(e)}")
    
    @with_timeout(60)
    def check_integration(self, repo, repo_owner: str, repo_name: str) -> CeloIntegrationResult:
        """
