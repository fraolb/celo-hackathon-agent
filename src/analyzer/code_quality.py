...
class CodeQualityAnalyzer:
    ...
    def analyze_without_access(self, repo_owner: str, repo_name: str, repo_description: str) -> CodeQualityResult:
        """
        ...
        if self.llm is not None:
            try:
                return self.estimate_quality_with_ai(repo_owner, repo_name, repo_description)
    ...
    def estimate_quality_with_ai(self, repo_owner: str, repo_name: str, repo_description: str) -> CodeQualityResult:
        """
    ...
    def estimate_quality_with_heuristics(self, repo_owner: str, repo_name: str) -> CodeQualityResult:
        """
    ...
    @with_timeout(60)
    def analyze_code_samples(self, code_samples: List[str], file_metrics: CodeQualityMetrics) -> CodeQualityResult:
        """
    ...
    def analyze_with_ai(self, code_samples: List[str], file_metrics: CodeQualityMetrics) -> CodeQualityResult:
        """
    ...
    def analyze_with_heuristics(self, file_metrics: CodeQualityMetrics) -> CodeQualityResult:
        """
    ...
    def calculate_weighted_score(self, readability: float, standards: float, 
